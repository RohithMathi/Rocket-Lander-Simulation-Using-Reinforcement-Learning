...
class Main:
    ...
    def two_layers_network(self,x,layer_1_nodes=32,layer_2_nodes=32):
        layer_1=slim.fully_connected(x,layer_1_nodes,activation_fn=tf.nn.relu)
        layer_2=slim.fully_connected(layer_1,layer_2_nodes,activation_fn=tf.nn.relu)
        return slim.fully_connected(layer_2,self.nA,activation_fn=None)
...
class Environment:
    ...
    def train(self, epsilon=1.0, episodes=700):
...
#lunar_lander.incremental(epsilon=0.1)
